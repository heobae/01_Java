...
//		car3.setDiscountOffer(0.5);
		...
		// 객체 배열 : 같은 객체 참조자료형의 변수를 하나의 묶음으로 다루는 것
		// 다형성을 이용한 객체배열 : 
		// 부모타입 참조자료형의 변수를 하나의 묶음으로 다루는 것
	...
	// 전달 받은 Car 또는 자식객체 (Tesla, Spark)의 엔진, 연료, 바퀴개수를 출력하는 메서드
	...
	// 매개변수로 전달받은 정수값에 따라 Car, Tesal, s
	public Car createCar(int num) {
		// ㄴ result가 Car타입이라서
		Car result = null;
		
		switch(num) {
		case 1 : result = new Car(); break; // 업캐스팅 진행중 result가 Car타입
