...
//		TestVO test = new TestVO(); 
		// TestVO 클래스는 (default) class이기 때문에 import 불가능 (다른 패키지라 불가능)
		
		// 필드 접근제한자 확인하기
		System.out.println(std.v1);
		// -> 전체에서 직접접근 가능한 public인 v1만 에러발생 X
...
//		System.out.println(v3); // (default) 다른 패키지라 X
//		System.out.println(v4); // 해당클래스 내부가 아닌 다른 클래스에 있어서
	}
	...
	public void ex2() {
		...
		System.out.println(std1.schoolName); // static으로 만들어서 글자 기울어짐
		System.out.println(std2.schoolName);
		
		// schoolName에 노란줄이 뜨는 이유(경고) -> 작성을 제대로 X
	...
	public void ex3() {
		...
		// 해결방법 1 : setter 를 이용해서 새로운 값 재대임
	...
	public void ex4() {
		...
		User u2 = new User("user02", "pass02"); // 매개변수 2개 초기화
		User u3 = new User("user03", "pass03", "김길동", 30 , '남'); // 매개변수 전체초기화
