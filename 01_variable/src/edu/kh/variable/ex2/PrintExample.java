...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		// System.out.println(); : 한 줄 출력용 메서드 (출력 후 콘솔창 줄바꿈 수행)
		System.out.println("테스트1");
		System.out.println("테스트2");
		
		// System.out.print(); : 단순 출력용 메서드 (출력 후 줄바꿈 없음)
		...
		System.out.println(); // (바로 위에 print() 사용했으니 줄바꿈 해줌ㅋㅋ)
		...
		System.out.printf("%d + %d = %d\n", iNum1, iNum2, iNum1+iNum2); // 줄바꿈이 안됨
		// 줄바꿈 : \n
...
*/
		...
		// false / 가 / 안녕하세요~!
		System.out.printf("%b / %c / %s\n", isTrue, ch, str); // ("패턴" , 값/변수)
		
		//     \
		System.out.println("\\"); // 2개 써줘야 함. 1개는 이스케이프 문자
		
		//     \o/
		System.out.println("\\o/");
		
		// \t : tab (한 공간씩 표현X , 한번에 공간차지, 드래그 해보면 한칸임)
