...
public class ConditionExample {
	...
	public void ex2() {
		...
		if(input % 2 != 0) { // 2로 나눴을 때 0과 같지 않다 (홀수다)
	...
	public void ex5() {
		...
		if ( age <= 13) {                 //결과값이 한줄이면 중괄호 생략 가능
			result = "어린이입니다.";     //if(age <= 13) result = "어린이입니다.
		} else if( age <= 19 ){			  //else if(age <= 19) re ~~~
			result = "청소년입니다.";
		} else {
			result = "성인입니다.";
		}
