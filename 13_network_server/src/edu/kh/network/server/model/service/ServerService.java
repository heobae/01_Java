...
public class ServerService {
	...
	public void serverStart() {
		...
		// 1) 서버의 포트번호 정함
		int port = 8500;
		// 포트는 0 ~ 65546 사이를 지정할 수 있으나
		// 0123번 이하는 이미 사용 중인 경우가 많으니 피하는게 좋음
		...
		try {
			...
			// 2025년 03월 06일 12:17:30 [서버 접속 성공] -> 클라에게
			...
			// getInetAddress() : 클라이언트에 대한 IP주소 정보를 포함하는 InetAddress 객체 반환.
